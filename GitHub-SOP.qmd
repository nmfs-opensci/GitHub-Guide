...
Note, secrets scanners like gitlinks need to be customized and tested. Also, They are designed for to catch secrets that look like AWS keys or API keys and not confidential fisheries data or a simple text password hard-coded into a script. 
...
The editors assembled the material into a cohesive format, but significant sections were developed by other individuals in other contexts.

* Much of the section on setting up your GitHub individual account was adapted from the [SEFSC October 2021 GitHub SOP](https://docs.google.com/document/d/1cH7Bb3loSGAotkhz4BM6DUzi-vY-kSy2_3CLkI0X5ao/edit?usp=sharing). This SOP effort was led by James Primrose, SEFSC.
