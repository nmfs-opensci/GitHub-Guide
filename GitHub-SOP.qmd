...
:::{.callout-important}
NOAA's official GitHub policy from 2017 may be found [here](images/NOAA-GitHub-Usage-Guidelines.pdf) and the CIO memo authorizing GitHub use at NOAA is [here](images/CIO-Memo-Use-of-GitHub-at-NOAA.PDF). Some individual centers and offices have their own GitHub Guidelines and SOPs. In addition, your division or program may already have a GitHub organization and have a SOP for contributing to that. This document is not intended to replace these guidelines but to supplement them and help NMFS staff follow them by giving pragmatic guidelines.
:::
...
* [2017 CIO Memo authorizing GitHub use at NOAA](images/CIO-Memo-Use-of-GitHub-at-NOAA.PDF) -- Note this appears to be intended for GitHub Free. This was written before Microsoft bought GitHub and before GitHub Enterprise.
* [2017 NOAA GitHub Guidelines for NOAAGov GitHub Org](images/NOAA-GitHub-Usage-Guidelines.pdf) -- Note this document appears to be intended to apply only to content on https://github.com/NOAAGov. See top of page 2.
* [NOAA GitHub Checklist](images/NOAA-GitHub-Checklist.pdf) -- Note this document appears to be intended to apply only to content on https://github.com/NOAAGov. References the GitHub Guideline document above which is written for the NOAAGov GitHub organization.
