...
* Much of the section on setting up your GitHub individual account was adapted from the SEFSC October 2021 GitHub SOP. This SOP effort was led by James Primrose, SEFSC.
* Most of the information on standard elements of a NMFS repository (disclaimers, readme, logos, etc) was adapted or taken directly from the Fisheries Integrated Toolbox  [Resource pages](https://noaa-fisheries-integrated-toolbox.github.io/resources/). Christine Stawitz, Kathryn Doering, and Bai Li, OST, were the developers of the FIT material.
